...
mesh = trimesh.load('skulls/CT Cleaned.stl')
...
vertices, faces, normals, _ = skimage.measure.marching_cubes_lewiner(voxels, level=0, allow_degenerate=False)
mesh = trimesh.Trimesh(vertices=vertices, faces=faces, vertex_normals=normals)
mesh.export("skull_test_2.obj")
#mesh.show()
